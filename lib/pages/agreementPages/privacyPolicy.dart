...
class PrivacyPolicyPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
        create: (context) => PrivacyPolicyModel(context), child: PrivacyPolicyView());
  }
}
  ...
  Widget build(BuildContext context) {
    return CupertinoPageScaffold(
        ...
        child: Padding(
          ...
          children: <Widget>[
            Text(
            Provider.of<PrivacyPolicyModel>(context, listen: false)._policyTitle,
            style:TextStyle(color:Color(0xFF13ACD9),fontSize: 26,fontWeight:FontWeight.bold),
            textAlign: TextAlign.center,
            ),
            Text(
            Provider.of<PrivacyPolicyModel>(context, listen: false)._policyText,
            style:TextStyle(color:Color(0xFF13ACD9),fontSize: 18),
